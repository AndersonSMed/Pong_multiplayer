...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerPlatformBehavior : NetworkBehavior
	{
		...
		public PlayerPlatformNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerPlatformNetworkObject)obj;
		...
		{
			Initialize(new PlayerPlatformNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerPlatformNetworkObject(networker, this, createCode, metadata);
		}
